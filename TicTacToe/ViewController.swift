...
//  TicTacToe
//
//  Created by ITESM Campus Puebla on 23/10/23.
//
...
class ViewController: UIViewController {
    ...
    func setMove(number: Int, mark:String){
        ...
        case 0: label1.setTitle(mark, for: .normal)
            break
        case 1: label2.setTitle(mark, for: .normal)
            break
        case 2: label3.setTitle(mark, for: .normal)
            break
        case 3: label4.setTitle(mark, for: .normal)
            break
        case 4: label5.setTitle(mark, for: .normal)
            break
        case 5: label6.setTitle(mark, for: .normal)
            break
        case 6: label7.setTitle(mark, for: .normal)
            break
        case 7: label8.setTitle(mark, for: .normal)
            break
        case 8: label9.setTitle(mark, for: .normal)
            break
        default:break
